...
const images = {
  ...
  archiEP: require('../assets/image/archiep.png'),
...
export default [
  <Slide key='pk-0'>
    <Heading textColor='secondary' fit caps>
      Pourquoi ReactJS @Lyra ?
    </Heading>
    <Appear>
      <List>
        <Appear><ListItem>AngularJS ou ReactJS ?</ListItem></Appear>
        <Appear><ListItem>Performance, Production-Ready </ListItem></Appear>
      </List>
    </Appear>
  </Slide>,
  <Slide key='sepa-0'>
  ...
  <Slide key='pk-1'>
    ...
    <Appear>
      <List>
        <Appear><ListItem>Retour d'expérience du projet LUMA</ListItem></Appear>
        <Appear><ListItem>Similitudes avec SEPAMAIL</ListItem></Appear>
        <Appear><ListItem>Simplicité & Efficacité</ListItem></Appear>
      </List>
    </Appear>
  </Slide>,
  <Slide key='pk-1'>
    ...
    <Image src={images.archiEP} height={200} />
  </Slide>,
  <Slide key='mu-0'>
    <Heading textColor='secondary' fit caps>
      Mutualisation
    ...
    <List>
      <Appear><ListItem>Beaucoup de code dupliqué</ListItem></Appear>
      <Appear><ListItem>Besoin de mutualiser les efforts</ListItem></Appear>
      <Appear><ListItem>Partage intra projet complexe</ListItem></Appear>
    </List>
  </Slide>,
  <Slide key='bp-0'>
    <Heading textColor='secondary' fit caps>
